...
| QA-005 | Gameplay audio continues outside active play | Audio state / Gameplay QA | monitor | 2026-05-11 | 2026-05-11 | User reported failed audible validation for `Master 15.10` and `Master 15.11`; `Master 15.12` proved the countdown can now be heard; `Master 15.13` established the right race-light beep sound but failed timer synchronization. `Master 15.14 - synced-race-light-countdown.html` increases beep volume and triggers countdown audio from the same HUD update that displays `0:03`, `0:02`, and `0:01`, while retaining the `15.11` active-gameplay audio gates. | Codex / Project Manager | yes | yes | User must validate `15.14`: countdown is heard at the same time the timer displays `0:03`, `0:02`, and `0:01`; the tone remains the same each time and louder than `15.13`; visible/debug cue proof appears; menu/game-over audio remains silent except music. |

...
| QA-005 | Gameplay audio continues outside active play | Audio state / Gameplay QA | monitor | 2026-05-11 | 2026-05-11 | User reported failed audible validation for `Master 15.10` countdown plus aid radar, soldier warning, and plane sounds continuing or mismatching while on the game-mode selection screen. `Master 15.11 - audio-state-cleanup.html` adds stronger countdown output and gates aid, soldier, gunshot, and plane audio to active gameplay only. | Codex / Project Manager | yes | yes | User must validate `15.11`: countdown is heard at 3, 2, and 1 seconds; aid radar, soldier warning, gunshots, and plane engines stop when returning to game-mode selection or game-over. |

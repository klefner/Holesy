...
- `C:\Users\KentLefner\Desktop\game-repo\Holesy\10_SOURCE\Masters\Master 10.html`

Current basis note:

- `C:\Users\KentLefner\Desktop\game-repo\Holesy\10_SOURCE\Current\CURRENT_BASIS.md`

What `Master 10` specifically represents:

- it includes the full approved `Master 9` gameplay baseline
...
Last approved candidate promoted into `Master 10`:

- `C:\Users\KentLefner\Desktop\game-repo\Holesy\20_TESTS\Candidate_Builds\Master 9 - unit-clear-audio-juice-pass.html`
...
- the user explicitly confirmed the unit-clear audio / wind / timing candidate had no defects
- that build was promoted to `Master 10`
- current canonical baseline is therefore `Master 10`
...
2. Treat `Master 10` as the baseline

...
- `C:\Users\KentLefner\Desktop\game-repo\Holesy\10_SOURCE\Masters\Master 9.html`

Current basis note:

- `C:\Users\KentLefner\Desktop\game-repo\Holesy\10_SOURCE\Current\CURRENT_BASIS.md`

What `Master 9` specifically represents:

- it includes the full approved `Master 8` gameplay baseline
...
Last approved candidate promoted into `Master 9`:

- `C:\Users\KentLefner\Desktop\game-repo\Holesy\20_TESTS\Candidate_Builds\Master 8 - transition-pause-and-round-ui-sectioning.html`
...
- `P1.7` is now in progress and its first cleanup slice is promoted into `Master 9`
...
- the user explicitly confirmed the transition-pause and round-UI sectioning candidate had no defects
- that build was promoted to `Master 9`
- current canonical baseline is therefore `Master 9`
...
2. Treat `Master 9` as the baseline
...
5. Continue either:
   ...
   - `P1.7` if the user wants backlog-driven stabilization next

...
- `C:\Users\KentLefner\Desktop\game-repo\Holesy\10_SOURCE\Masters\Master 8.html`

Current basis note:

- `C:\Users\KentLefner\Desktop\game-repo\Holesy\10_SOURCE\Current\CURRENT_BASIS.md`

What `Master 8` specifically represents:

- it includes the full approved `Master 7` gameplay baseline
...
Last approved candidate promoted into `Master 8`:

- `C:\Users\KentLefner\Desktop\game-repo\Holesy\20_TESTS\Candidate_Builds\Master 7 - reset-restart-wave-transition-guard.html`
...
- the user explicitly confirmed the reset / restart / wave-transition guard candidate had no defects
- that build was promoted to `Master 8`
- current canonical baseline is therefore `Master 8`
...
2. Treat `Master 8` as the baseline

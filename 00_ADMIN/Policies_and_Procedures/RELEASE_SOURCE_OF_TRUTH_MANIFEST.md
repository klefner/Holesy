...
| Current Pages deployment branch | `claude/happy-clarke-ORWAI` | GitHub Pages publishes from this branch's `docs/` folder; commit `a09d152` publishes the directed-review build `Master 16.182`. Live verification on 2026-07-27 confirmed the 16.182 page and the Harvest County horse GLB (`200 OK`, 40,980 bytes, `model/gltf-binary`). |

...
| Current in-game build label | `Master 16.197` | Current published build; normal player surfaces display `Version 16.197`. It restores the full crowded Harvest population and full building breakup logic from `Master 16.194`, retains the higher Hole-Eye framing, and replaces unexplained reward jargon with explicit speed-boost and damage-protection language. |

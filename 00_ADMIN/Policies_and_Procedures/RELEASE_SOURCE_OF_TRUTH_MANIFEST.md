...
| Current Pages deployment branch | `claude/happy-clarke-ORWAI` | GitHub Pages publishes from this branch's `docs/` folder; commit `ef02687` publishes the complete `Master 16.203` package. Live verification on 2026-08-07 confirmed public build 203 metadata, both recorded WAV assets at their expected byte sizes, and the live fallback/transition routing. |

...
- Current patch label is `Master 16.20`.
...
- `Master 16.20` opens the separate How to Play field manual through the same explicit popup-window pattern used by the stats surface.

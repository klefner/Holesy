...
- Current patch label is `Master 16.18`.
...
- `Master 16.18` fixes the modular startup regression where menu event listeners did not wire after the script halted during initialization.

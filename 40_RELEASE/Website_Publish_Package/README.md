...
- Current patch label is `Master 16.21`.
...
- `Master 16.21` opens the separate How to Play field manual through the same explicit popup-window pattern used by the stats surface.

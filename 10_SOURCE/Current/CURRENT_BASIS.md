...
- `Master 16` is the approved build family; the current in-game label is `Master 16.50`
- `Master 16.50` is the current governed source basis and includes:

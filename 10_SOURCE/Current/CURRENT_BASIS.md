...
- `Master 16` is the approved build family; the current in-game label is `Master 16.48`
- `Master 16.48` is the current governed source basis and includes:

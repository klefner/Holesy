...
- `Master 16` is the approved build family; the current in-game label is `Master 16.40`
- `Master 16.40` is the current governed source basis and includes:
  ...
  - the `Master 16.40` same-side hole descent-path refinement that makes objects fall down from their actual mouth contact point instead of snapping toward a center drain

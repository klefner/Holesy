...
- `Master 16` is the approved build family; the current in-game label is `Master 16.21`
- `Master 16.21` is the current governed source basis and includes:
  ...
  - the separate How to Play field manual popup from `Master 16.21`, covering core controls, modes, Archive, buffs, save/load, stats, and survival basics

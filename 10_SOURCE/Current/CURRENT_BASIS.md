...
- `Master 16` is the approved build family; the current in-game label is `Master 16.49`
- `Master 16.49` is the current governed source basis and includes:

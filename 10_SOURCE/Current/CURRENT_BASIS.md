...
- `Master 16` is the approved build family; the current in-game label is `Master 16.22`
- `Master 16.22` is the current governed source basis and includes:
  ...
  - the separate How to Play field manual popup from `Master 16.22`, covering core controls, modes, Archive, buffs, save/load, stats, and survival basics
